...
output "nomad_server_ips_private" {
    ...
    value       = hcloud_server.nomad_servers.*.network[0].ip
}
...
output "nomad_client_stateful_ips_private" {
    ...
    value       = hcloud_server.nomad_clients_stateful.*.network[0].ip
}
...
output "nomad_client_stateless_ips_private" {
    ...
    value       = hcloud_server.nomad_clients_stateless.*.network[0].ip
}
